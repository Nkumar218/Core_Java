...
public class TwoMissingNumber 
{
	...
	{ 
		...
		int avg = (sum / 2); 
		// Find sum of elements smaller than average (avg) and sum of elements greater than average (avg) 
		...
		// The first (smaller) element = (sum of natural numbers upto  avg) - (sum of array elements smaller than or equal to avg)
		int totalSmallerHalf = (avg * (avg + 1)) / 2; 
		System.out.println(totalSmallerHalf - sumSmallerHalf); 
		// The first (smaller) element =(sum of natural numbers from  avg+1 to n) - (sum of array elements greater than avg) 
